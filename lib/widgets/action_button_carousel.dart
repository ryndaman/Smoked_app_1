  ...
  Widget build(BuildContext context) {
    return Consumer<SmokeDataProvider>(builder: (context, dataProvider, child) {
      ...
      final List<Widget> actionButtons = [
        _ActionButton(  // Action Button "I smoked one "
          label: "I smoked one",
        ...
        _ActionButton(  // Action Button "Ride the Wave"
          label: "Ride the Wave",
...
const int durationElev = 100; // Default elevation for the button
...
with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _elevationAnimation = Tween<double>(begin: buttonElev, end: 0).animate(
  ...
  @override
  Widget build(BuildContext context) { //Render the action button with animation
    return AnimatedBuilder(
